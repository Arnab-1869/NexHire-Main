...
export const API_ENDPOINTS = {
  ...
  TRAINEES: {
    ...
    BY_BATCH: (batchId: number) => `${BASE}/api/training/batch/${batchId}`,
    ASSIGN_BATCH: `${BASE}/api/training/assign`,
    MOVE_TO_LAP: (traineeId: number) => `${BASE}/api/training/${traineeId}/lap`,
    REMOVE_LAP: (traineeId: number) => `${BASE}/api/training/${traineeId}/remove-lap`,
    FLAG: (traineeId: number) => `${BASE}/api/training/${traineeId}/flag`,
    COMPLETE_BATCH: (batchId: number) => `${BASE}/api/training/batch/${batchId}/complete`,
    EXCEPTIONS: `${BASE}/api/training/exceptions`,
    RESOLVE_EXCEPTION: (traineeId: number) => `${BASE}/api/training/exceptions/${traineeId}/resolve`,
    PROGRAMS: `${BASE}/api/training/programs`,
    BLOCKS: `${BASE}/api/training/blocks`,
  },
  ...
  CANDIDATE_PROFILE: {
    ...
    CHECK: `${BASE}/api/candidate/profile/check-completion`,
  },

  // ─── Excel Import ─────────────────────────────────────────────────────────
  EXCEL_IMPORT: {
    ASSESSMENT: `${BASE}/api/import/assessment`,
    BGC: `${BASE}/api/import/bgc`,
    TRAINING: (batchId: number) => `${BASE}/api/import/training/${batchId}`,
    LOGS: `${BASE}/api/import/logs`,
    ERRORS: (logId: number) => `${BASE}/api/import/logs/${logId}/errors`,
    TEMPLATE_ASSESSMENT: `${BASE}/api/import/template/assessment`,
    TEMPLATE_BGC: `${BASE}/api/import/template/bgc`,
    TEMPLATE_TRAINING: `${BASE}/api/import/template/training`,
  },
  ...
  JOINING_BATCHES: {
    ...
    ELIGIBLE_CANDIDATES: `${BASE}/api/joining-batches/eligible-candidates`,
    ASSIGN: (batchId: number) => `${BASE}/api/joining-batches/${batchId}/assign`,
    SEND_LETTERS: (batchId: number) => `${BASE}/api/joining-batches/${batchId}/send-letters`,
  },
} as const;
